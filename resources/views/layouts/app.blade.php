...
<head>
    ...
    <link href="{{ asset('toast/css/mk-notifications.css') }}" rel="stylesheet">
	...
	<script src="{{ asset('toast/js/mk-notifications.js') }}" defer></script>
</head>
<body>
	<div class="overlay-loader no-display" style="display: none; background: none repeat scroll 0 0 rgba(238,238,238,0.75);left: 0;position: fixed;right: 0;top: 0;bottom: 0;z-index:99999999;">
		<img src="{{ asset('images/loading.gif') }}" style="position: fixed;top: 46%;left: 46%;width: 8%;"/>
	</div>
    <div id="app">
